...
ptr_t stencil_7(ptr_t arr, ptr_t aux, const dist_grid_info_t *info, int nt, double * calc_time, double * comm_time);
ptr_t stencil_27(ptr_t arr, ptr_t aux, const dist_grid_info_t *info, int nt, double * calc_time, double * comm_time);
